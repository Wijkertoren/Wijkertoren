...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Volgende",sPrevious:"Vorige"},sEmptyTable:"No data available in table",sInfo:"_START_ van _END_ de _TOTAL_ leden",sInfoEmpty:" 0 van 0 de 0 leden",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ leden per pagina",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Zoeken:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
...
" ui-corner-tl ui-corner-tr",sJUIFooter:Yb+" ui-corner-bl ui-corner-br"});var Nb=m.ext.pager;h.extend(Nb,{simple:function(){return["Vorige","Volgende"]},full:function(){return["first","Vorige","Volgende","last"]},numbers:function(a,b){return[ia(a,b)]},simple_numbers:function(a,b){return["previous",ia(a,b),"next"]},full_numbers:function(a,b){return["first","previous",ia(a,b),"next","last"]},first_last_numbers:function(a,b){return["first",ia(a,b),"last"]},_numbers:ia,numbers_length:7});h.extend(!0,m.ext.renderer,
