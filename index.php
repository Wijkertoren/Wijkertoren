            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="input-group">
                        <span class="input-group-addon" id="searchbar">Zoeken</span>
                        <input type="text" class="form-control" placeholder="zoeken..." aria-describedby="searchbar_input">
                    </div>            
                </div>
            </div>
            <div class="row">
